class Users::RegistrationsController < Devise::RegistrationsController
  ...
  protected
    ...
    def configure_sign_up_params
      devise_parameter_sanitizer.permit(:sign_up, keys: [:locale, :token, :mobile_no, :first_name, :last_name, :is_merchant])
      devise_parameter_sanitizer.permit(:account_update, keys: [:locale, :token, :mobile_no, :first_name, :last_name, :organization_name, :is_merchant])
    end
